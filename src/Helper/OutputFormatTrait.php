...
trait OutputFormatTrait
{
    ...
    private function getFormat(\Symfony\Component\Console\Input\InputInterface $input): string
    {
     ...
     * @param array<array{0: string, 1?: string, 2?: string, 3?: string, 4?: string, 5?: string}> $rows
     */
